...
vim.keymap.set("n", "<S-h>", ":bnext<CR>", { silent = false })
vim.keymap.set("n", "<S-l>", ":bprevious<CR>", { silent = false })
...
vim.keymap.set("n", "<<leader>bd>", ":bwipeout<CR>", { silent = false })
...
vim.keymap.set(
	...
	"<C-s>",
	"<cmd>w<cr><esc>",
	{ desc = "Save File", silent = true, noremap = true }
)
